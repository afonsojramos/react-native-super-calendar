...
For a detailed, feature-by-feature matrix against the other React Native calendar
libraries, see the [comparison](/comparison). Porting from a specific library?
There are guides for [react-native-big-calendar](/migrating-from-big-calendar),
[calendar-kit](/migrating-from-calendar-kit),
[FullCalendar](/coming-from-fullcalendar), and
